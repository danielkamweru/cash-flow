...
from app.routers import actions, api, auth, automation, business, coach, mpesa, resources
...
def create_app() -> FastAPI:
    ...
    application = FastAPI(title="Cash-Flow API", version="0.2.0", lifespan=lifespan)
    ...
    application.include_router(mpesa.router)
